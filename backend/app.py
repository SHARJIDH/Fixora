...
def handle_webhook():
    ...
    if '@fixora' not in comment_body:
        logger.debug("webhook_ignored", reason="fixora not mentioned")
        return jsonify({'message': 'Ignored: @fixora not mentioned'}), 200
...
def test_issue():
    ...
    comment_body = data.get('comment_body', '@fixora')
