...
A GitHub automation tool that creates pull requests in response to issue comments. When someone comments `@fixora` on an issue, an AI agent analyzes the codebase, generates fixes, **validates them in a Docker sandbox**, and creates a PR.
