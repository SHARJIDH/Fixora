...
2. Click "Create User" → Name it "fixora-admin"
...
aws s3 mb s3://fixora-sandbox-code-$AWS_ACCOUNT_ID --region $AWS_REGION

# Enable encryption
aws s3api put-bucket-encryption \
    --bucket fixora-sandbox-code-$AWS_ACCOUNT_ID \
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "arn:aws:s3:::fixora-sandbox-code-$AWS_ACCOUNT_ID",
                "arn:aws:s3:::fixora-sandbox-code-$AWS_ACCOUNT_ID/*"
            ]
        },
        {
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:s3:::fixora-sandbox-code-$AWS_ACCOUNT_ID/*"
        },
        {
            "Effect": "Allow",
            "Action": [
...
AWS_S3_BUCKET=fixora-sandbox-code-<your-account-id>
...
aws s3 ls s3://fixora-sandbox-code-$AWS_ACCOUNT_ID/
...
aws s3 rb s3://fixora-sandbox-code-$AWS_ACCOUNT_ID --force
