...
export default function Dashboard() {
  ...
  useEffect(() => {
    const savedRepo = localStorage.getItem("fixora_selected_repo");
    if (savedRepo) setSelectedRepo(savedRepo);
  }, []);

  useEffect(() => {
    if (selectedRepo) {
      localStorage.setItem("fixora_selected_repo", selectedRepo);
    }
  }, [selectedRepo]);
  ...
  useEffect(() => {
    const hasSeenOnboarding = localStorage.getItem("fixora_onboarding_seen");
  ...
  function handleCloseOnboarding(): void {
    ...
    localStorage.setItem("fixora_onboarding_seen", "true");
  }
