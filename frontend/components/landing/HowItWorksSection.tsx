...
const steps: Step[] = [
  {
    number: "01",
    title: "Select your GitHub repository and branch. Write a detailed prompt for Fixora.",
    description: "Use the \"fixora\" label in an issue to assign a task directly in GitHub.",
    icon: (
  ...
  {
    number: "02",
    title: "Fixora fetches your repository, clones it to a Cloud VM, and develops a plan utilizing the latest model.",
    description: "",
    icon: (
      <div className="w-full h-36 bg-black border border-gray-800 p-4 font-retro-body text-base text-gray-400 overflow-hidden relative retro-scanlines">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-5 h-5 border border-orange-500 flex items-center justify-center text-orange-500 text-xs">N</div>
          <span className="text-orange-500">Fixora_AI</span>
        </div>
        <div className="text-gray-300">
          <TypewriterText 
  ...
  {
    number: "03",
    title: "Fixora provides a diff of the changes. Quickly browse and approve code edits.",
    description: "",
    icon: (
  ...
  {
    number: "04",
    title: "Fixora creates a PR of the changes. Approve the PR, merge it to your branch, and publish it on GitHub.",
    description: "",
    icon: (
