...
const faqs: FAQ[] = [
  {
    question: "How do I use Fixora to fix an issue?",
    answer: "Simply comment @fixora on any GitHub issue in your repository. Our AI will analyze the issue, understand the context of your codebase, and create a pull request with the fix – usually within 5 minutes.",
  },
  {
    question: "What types of issues can Fixora fix?",
    answer: "Fixora handles bug fixes, simple feature additions, refactoring tasks, dependency updates, documentation updates, and configuration changes. For complex architectural changes, it works great as a first draft you can iterate on.",
  },
  {
  ...
  },
  {
    ...
    answer: "Just comment on the PR with feedback like you would with any developer. Fixora will read your comments, understand the issues, and push updated commits. It learns from your feedback to get better over time.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! Fixora creates standard pull requests that go through your normal review and CI/CD process. It validates code in Docker containers before creating the PR, so your CI checks usually pass on the first try.",
  },
];
